...
function createVNode(type, props, children) {
    ...
    if (typeof children === 'string') {
        vnode.shapeFlags = vnode.shapeFlags | 8;
    }
    else if (Array.isArray(children)) {
        vnode.shapeFlags = vnode.shapeFlags | 16;
    }
    if (vnode.shapeFlags & 4) {
...
export { createApp, createVNode as createElementVNode, createTextVNode, getCurrentInstance, h, renderSlots };
